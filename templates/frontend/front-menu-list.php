...
$main_menu = [
    ...
    [
        ...
        "active_classes" => esc_attr($active_class['escrow_list'] . $active_class['earning_list'] . $active_class['view_transaction']),
        "type" => "drop-down",
        "href" => "javascript:;",
    ...
    [
        ...
        "active_classes" => esc_attr($active_class['support_tickets'] . $active_class['view_ticket']),
        "type" => "drop-down",
        "href" => "javascript:;",
        ...
        "submenus" => [
            ...
            [
                ...
                "type" => "normal",
                "href" => esc_url($routes['support_tickets']),
                "icon" => "ticket",
...
// User Profile Menu
$user_name = strlen($user_data["username"]) > 10 ? substr(esc_html($user_data["username"]), 0, 10) . '..' : esc_html($user_data["username"]);
    ...
    [
        ...
        "submenus" => [
            ...
            [
                ...
                "href" => "#",
                "icon" => "user_group",
                "title" => __("Balance: ", "escrowtics") . esc_html($user_data["balance"]) . ' ' . ESCROT_CURRENCY,
                "collapse-id" => "",
                "submenus" => [],
            ],
        ],
