		...
		<div class="d-sm-flex align-items-center justify-content-between mb-4" id="escrot-admin-area-title">
			...
			<div class="card-header d-none d-md-block " style="text-align:center;">
               ...
               <span class="escrot-tbl-header"><?php echo __("User Withdrawals", "escrowtics"); ?></span></h3>
			</div>
			  
			<button id="escrot-export-to-excel" data-action="escrot_export_withdrawals_excel" class="btn btn-round m-1 float-right escrot-btn-white"> <i class="fa fa-download"></i> <?php echo __("Export Excel", "escrowtics"); ?> </button>
			
			<div class="card-header  d-block d-md-none" style="text-align:center;">
              <h3> <i class="fas fa-circle-dollar-to-slot tbl-icon"></i>
              <span class="escrot-tbl-header"><?php echo __("User Withdrawals", "escrowtics"); ?></span> &nbsp;&nbsp;  <button type="button" class="btn btn-round btn-just-icon" style="background-color:transparent; box-shadow: none;" title="Reload Table" id="reloadTable"><i class="fas fa-sync-alt"></i></button></h3>
			 </div>
		</div>
		...
		<?php 
		   ...
		   $dialogs = [
				   ...
				   ['id' => 'escrot-withdrawal-status-dialog',
					'data_id' => '',
					'header' => '',
