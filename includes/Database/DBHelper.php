...
class DBHelper
{
     ...
     */
    public function escrotQuery($sql, $params = [], $returnType = 'results'){
     ...
     */
    public function escrotInsert($table, $data){
     ...
     */
    public function escrotUpdate($table, $data, $where){
     ...
     * @return int|false Number of rows affected or false on failure.
     */
    public function escrotDelete($table, $where){
