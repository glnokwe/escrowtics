 ...
 */
	...
	class AdminMenu {
		...
		public function capability() {
			...
			$plugin_role = ESCROT_ACCESS_ROLE;
		...
		public function setSubpages(){
			...
			$this->subpages = array(
				...
				array(
					'parent_slug' => 'escrowtics-dashboard', 
					'page_title' => 'Escrowtics Support Tickets', 
					'menu_title' => 'Support Tickets', 
					'capability' => $this->capability(), 
					'menu_slug' => 'escrowtics-support-tickets', 
					'callback' => array( $this->callbacks, 'adminGenTemplate' ), 
				),
				array(
					'parent_slug' => 'escrowtics-dashboard', 
				...
				array(
					'parent_slug' => 'escrowtics-dashboard', 
					'page_title' => 'Escrowtics View Ticket', 
					'menu_title' => '', 
					'capability' => $this->capability(), 
					'menu_slug' => 'escrowtics-view-ticket', 
					'callback' => array( $this->callbacks, 'adminGenTemplate' ), 
				)
			);
		}
