<?php
/**
 * Server-side processing class for Escrowtics DataTables
 *
 * @since      1.0.0
 * @package    Escrowtics
 */
...
class SSP {
    ...
    static function simple($request, $table, $primaryKey, $columns) {
     ...
     /**
     * Fetch users with the 'escrowtics_user' role and format data for DataTables
     * 
     * @param array $request Data sent to server by DataTables
     * @param array $columns Column information array
     * @return array Server-side processing response array
     */
	 static function getEscrotUsers($request, $columns) {
