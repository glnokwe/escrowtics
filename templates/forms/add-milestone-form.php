<form id="escrot-milestone-form" enctype = "multi-part/form-data">
	...
	value="<?php echo ( isset($_GET["earn_id"])? $_GET["earn_id"] : (isset($_GET["escrow_id"])? $_GET["escrow_id"] : '') ); ?>">
    <?php wp_nonce_field('escrot_milestone_nonce', 'nonce'); ?>
	<div id="escrot-milestone-error" class="text-danger"></div>	
	<div class="card-body p-5">
		<div class="row">
			<div class="col-md-12"><label><h3 class="text-light"><?php echo __("Transaction Details", "escrowtics"); ?></h3></label></div>
			<?php 
				$form_type = "add";
				include ESCROT_PLUGIN_PATH."templates/forms/form-fields/escrow-form-fields/escrow-meta-form-fields.php"; 
			?>
		</div><br>
		<button type="submit" class="btn escrot-btn-primary" id="escrot-milestone-btn"><?php echo __("Add Escrow Milestone", "escrowtics"); ?></button>
