...
<div class="escrot-payment-wrap p-4 p-lg-5">
	<div class="d-flex">
		<div class="w-100">
			<h3 class="mb-4">Decide How You Want Deposit Money </h3>
			<small><b>Deposit Limits (1 - 20000) USD </b></small>
		</div>
	</div>
	<div class="text-danger" id="escrot-manual-deposit-error"></div>
	<form enctype="multi-part/form-data" id="escrot-manual-deposit-form">
		<input type="hidden" name="action" value="escrot_generate_manual_deposit_invoice">
		...
		<div class="row">
			...
			<select class="form-control" id="escrot-manual-deposit-payment-select" name="payment_methods">
		    ...
		    <div id="escrot-manual-deposit-other-payment" class="collapse col-md-12">
				<div class="form-group mb-3">
